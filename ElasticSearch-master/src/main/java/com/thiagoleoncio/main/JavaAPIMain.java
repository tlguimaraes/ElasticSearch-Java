package com.thiagoleoncio.main;
...
public class JavaAPIMain {
    ...
    public static void main(String args[]) throws IOException{
        ...
        client.prepareIndex("thiagoleonciocom", "article", "1")
        ...
        client.prepareIndex("thiagoleonciocom", "article", "2")
        ...
        getDocument(client, "thiagoleonciocom", "article", "1");

        updateDocument(client, "thiagoleonciocom", "article", "1", "title", "ElasticSearch: Java API");
        updateDocument(client, "thiagoleonciocom", "article", "1", "tags", new String[]{"bigdata"});

        getDocument(client, "thiagoleonciocom", "article", "1");

        searchDocument(client, "thiagoleonciocom", "article", "title", "ElasticSearch");

        deleteDocument(client, "thiagoleonciocom", "article", "1");
