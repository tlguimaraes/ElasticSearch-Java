 ...
 */
package com.thiagoleoncio.web.bean;

import com.thiagoleoncio.service.ClientProvider;
import com.thiagoleoncio.web.document.Article;
...
public class ElasticSearchBean {
    ...
    private static final String INDEX_NAME = "thiagoleonciocom";
